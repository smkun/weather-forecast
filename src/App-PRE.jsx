...
const App = () => {
    ...
    const [coordinates, setCoordinates] = useState([38.99, -77.53]);
    ...
    const fetchData = async (city) => {
        try {
            ...
            if (data.forecast && data.forecast.forecastday) {
                const newWeatherState = data.forecast.forecastday.map(
                    (day) => ({
                        date: day.date,
    ...
    return (
        <main>
            ...
            {locationInfo.city && (
                <h2>
                    Weather for {locationInfo.city}, {locationInfo.state}
                </h2>
            )}
